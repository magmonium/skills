...
Source of truth: `~/.claude/skills/` on dev machine. `./sync.sh` copies tracked skills into plugin folders, bumps patch version of changed plugins, commits, pushes. launchd agent `com.magmonium.skills-sync` watches skill folders and runs it automatically.
